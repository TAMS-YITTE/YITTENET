  ...
  return (
    <div className="container" style={{ padding: '4rem 0', maxWidth: '600px' }}>
      ...
      <div className="card">
        ...
        {errorMsg && (
          <div style={{ padding: '1rem', backgroundColor: 'rgba(233, 64, 87, 0.1)', color: 'var(--domain-genai)', borderRadius: '8px', marginBottom: '1.5rem', display: 'flex', alignItems: 'center', gap: '0.5rem', border: '1px solid rgba(233, 64, 87, 0.2)' }}>
